...
module.exports = require('express').Router()
    .get(studyCenterServiceUrls.classBooking.booked, function (req, res, next) {
        return proxyBPlus({path: '/classRequest/load/' + req.body.member_id, method: 'GET'})(req, res, next);
    })
