...
define(["domReady!", 
  ...
  ], function(document, angular, skills, personalinfo, educationbackground, club,
    container, personalinfoContainerTemplate, skillsContainerTemplate, eduContainerTemplate, clubContainerTemplate) {
  return {
    start: function() {
