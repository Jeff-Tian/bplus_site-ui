        ...
        concat: {
            production: {
                files: {
                    ...
                    '<%= config.dist %>js/cdn/index.js': ['<%= config.dist %>js/directives/captcha.js', '<%= config.dist %>js/directives/ngEnter.js', '<%= config.dist %>js/directives/registerForm.js', '<%= config.dist %>js/directives/tab.js', '<%= config.dist %>js/factories/WechatLogon.js', '<%= config.dist %>js/controllers/LoginCtrl.js', '<%= config.dist %>js/controllers/SignUpCtrl.js', '<%= config.dist %>js/controllers/WechatLoginCtrl.js', '<%= config.idst %>js/common/linkedInModule.js', '<%= config.dist %>js/page/homepage/main.js'],
